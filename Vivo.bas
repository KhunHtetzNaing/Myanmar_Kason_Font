...
Sub Globals
	...
	Dim lb As Label
	Dim mm As Typeface : mm = mm.LoadFromAssets("Kason.ttf")
End Sub
...
Sub Activity_Create(FirstTime As Boolean)
	...
	lb.Text = "	Install  ကိုနွိပ္ပါ။ ျပီးရင္ေအာက္ပါ Change Font1 ကိုနွိပ္ပါ Kason.txj (သို့) Kason.itz ကိုဖြင့္ၿပီး Apply လုပ္ေပးလိုက္ပါ မရခဲ့ရင္ Change Font2 ကိုနွိပ္ျပီး Myanmar Kason နာမည္နဲ့ Theme ကိုေရြးေပးလိုက္ပါ။ နဂိုမူလေဖာင့္ကိုျပန္ထားခ်င္ရင္ Change Font2 ကိုနွိပ္ျပီး Default ကိုျပန္ေရြးထားနိုင္ပါတယ္။"
	...
	tlb.Initialize("tlb")
	tlb.Text = "Vivo"
	tlb.Color = Colors.rgb(139, 195, 74)
	...
	Banner.Initialize2("Banner","ca-app-pub-4173348573252986/9530358954",Banner.SIZE_SMART_BANNER)
	Dim height As Int
	...
	Interstitial.Initialize("Interstitial","ca-app-pub-4173348573252986/2007092152")
	Interstitial.LoadAd
...
Sub b1_Click
	...
	If File.Exists(File.DirRootExternal & "/Vivo Myanmar Font","Kason.txj") = True Then File.Delete(File.DirRootExternal,"Vivo Myanmar Font/Kason.txj")
	File.Copy(File.DirAssets,"Kason.txj",File.DirRootExternal & "/Vivo Myanmar Font","Kason.txj")
	
	If File.Exists(File.DirRootExternal & "/Vivo Myanmar Font","Kason.itz") = True Then File.Delete(File.DirRootExternal,"Vivo Myanmar Font/Kason.itz")
	File.Copy(File.DirAssets,"Kason.itz",File.DirRootExternal & "/Vivo Myanmar Font","Kason.itz")
...
Sub b4_Click
	...
	If File.Exists(File.DirRootExternal & "/Download/i Theme/Font","Kason.txj") = True Then File.Delete(File.DirRootExternal,"Download/i Theme/Font/Kason.txj")
	File.Copy(File.DirAssets,"Kason.txj",File.DirRootExternal & "/Download/i Theme/Font","Kason.txj")
	
	If File.Exists(File.DirRootExternal & "/Download/i Theme/Font","Kason.itz") = True Then File.Delete(File.DirRootExternal,"Download/i Theme/Font/Kason.itz")
	File.Copy(File.DirAssets,"Kason.itz",File.DirRootExternal & "/Download/i Theme/Font","Kason.itz")
	Try
		Dim i As Intent
		i.Initialize("", "")
...
Sub SlideMenu_Click(Item As Object)
	...
	Select Item
		...
		Case 7 :
			...
			copy.clrText
			copy.setText("#Myanmar_Kason_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com/search?q=Myanmar+Kason+Font")
