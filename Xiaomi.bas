...
Sub b1_Click
	...
	'	If File.Exists(File.DirRootExternal & "/MIUI/theme","Kason.mtz") = True Then File.Delete(File.DirRootExternal,"MIUI/theme/Kason.mtz")
	'	File.Copy(File.DirAssets,"Kason.mtz",File.DirRootExternal & "/MIUI/theme","Kason.mtz")
